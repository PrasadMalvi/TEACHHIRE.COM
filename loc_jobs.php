	...
	<div id="container">																																																																																																																																																																											
	  ...
	  <div id="center" class="column">
		...
		<div id="accordion-container">
			...
			<?php
			$id=$_REQUEST['jb_loc_city'];
			//echo $id;
			$id1=$_REQUEST['jb_loc_state'];
			//echo $id1;
include('dbconnect.php');
$sql="select * from jobs j,job_category jc,company_details cd where j.jb_category_id=jc.jb_category_id and j.cmp_id=cd.cmp_id and j.jb_city='$id' and j.jb_state='$id1'";
//echo $sql;
